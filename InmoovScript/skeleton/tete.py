...
if isTete==1 and (ScriptType=="RightSide" or ScriptType=="Full"):
	...
	if TeteArduinoIsconnected:
		...
		# servo.attach(ARDUINO, PIN)		
		verinGauche.enableAutoEnable(1)
		verinDroite.enableAutoEnable(1)
		directionTete.enableAutoEnable(1)
		verinGauche.enableAutoDisable(0)
		verinDroite.enableAutoDisable(0)
