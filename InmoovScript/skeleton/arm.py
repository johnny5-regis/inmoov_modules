...
if isArm==1 and (ScriptType=="RightSide" or ScriptType=="Full"):
	...
	if ArmArduinoIsconnected:
		...
		# servo.attach(ARDUINO, PIN)		
		epauleGauche.enableAutoAttach(1)
		epauleDroit.enableAutoAttach(1)
		brasGauche.enableAutoAttach(1)
		brasDroit.enableAutoAttach(1)
		epauleGauche.enableAutoDetach(0)
		epauleDroit.enableAutoDetach(0)
		brasGauche.enableAutoDetach(0)
		brasDroit.enableAutoDetach(0)
